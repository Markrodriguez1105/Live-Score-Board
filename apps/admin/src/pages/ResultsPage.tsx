      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        {selectedCategory && (() => {
          ...
          const rankedCategoryCandidates = [...candidatesInCategory].sort((a, b) => b.catTotal - a.catTotal).map((c, i) => {
            // Check for ties in previous to share ranks if needed, but simple index + 1 is basic rank
            return { ...c, rank: i + 1, tieStatus: 'none' };
          });
          
          // Actually, let's implement standard dense ranking without tie-breakers
          let currentRank = 1;
